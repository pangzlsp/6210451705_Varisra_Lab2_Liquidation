...
describe("> Q2_Liquidation", function () {
  it("liquidate with 2000", async function () {
    console.log(
  ...
  it("liquidate with 5000 ", async function () {
    console.log(
  ...
  it("liquidate with 10000 (should got the transaction reverted)", async function () {
    console.log(
